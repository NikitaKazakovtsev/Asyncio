        ...
        async with ClientSession() as client_session:
            ...
            for character_data in json_value:
                if character_data is not None:
                    ...
                    films = await get_value_url(character_data["films"], "title"),
                    planets = await get_value_url(character_data["homeworld"], "name"),
                    species = await get_value_url(character_data["species"], "name"),
                    starships = await get_value_url(character_data["starships"], "name"),
                    vehicles = await get_value_url(character_data["vehicles"], "name"),
